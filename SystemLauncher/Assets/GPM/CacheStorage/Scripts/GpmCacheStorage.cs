namespace Gpm.CacheStorage
{
    ...
    public static class GpmCacheStorage
    {
        ...
        {
            return Request(url, new CacheRequestConfiguration(), onResult);
        }
        ...
        /// </summary>
        /// <param name="url">The url is the web address to request.</param>
        /// <param name="config">The config is a parameter for cache request.</param>
        /// <param name="onResult">This is a callback function that receives the results of cached data.</param>
        /// <returns>Cache information being requested.</returns>
        /// <example> 
        /// Example Usage : 
        ...
        ///     string url;
        ///     double reRequestTime = 30 * 24 * 60 * 60; // 30 Days
        ///     CacheRequestConfiguration config = new CacheRequestConfiguration(CacheRequestType.ALWAYS, reRequestTime);
        ///     GpmCacheStorage.Request(url, config, (result) =>
        ///     {
        ///         if (result.IsSuccess() == true)
        ///         {
        ///             bytes[] data = result.Data;
        ...
        /// </code>
        /// </example>
        public static CacheRequestOperation Request(string url, CacheRequestConfiguration config, Action<GpmCacheResult> onResult)
        {
            return CacheStorageImplement.Request(url, config, onResult);
        }
        ...
        {
            return Request(url, new CacheRequestConfiguration(requestType), onResult);
        }
        ...
        {
            return Request(url, new CacheRequestConfiguration(reRequestTime), onResult);
        }
        ...
        {
            return Request(url, new CacheRequestConfiguration(requestType, reRequestTime), onResult);
        }
        ...
        {
            return RequestTexture(url, new CacheRequestConfiguration(), false, onResult);
        }
        ...
        {
            return RequestTexture(url, new CacheRequestConfiguration(), preLoad, onResult);
        }
        ...
        ///     CacheRequestConfiguration config = new CacheRequestConfiguration(CacheRequestType.ALWAYS, reRequestTime);
        ///     bool preLoad = true;
        ///     GpmCacheStorage.RequestTexture(url, config, preLoad, (cachedTexture) =>
        ///     {
        ///         if (cachedTexture != null)
        ///         {
        ///             Texture texture = cachedTexture.texture;
        ...
        /// </code>
        /// </example>
        public static CacheRequestOperation RequestTexture(string url, CacheRequestConfiguration config, Action<CachedTexture> onResult)
        {
            return CacheStorageImplement.RequestTexture(url, config, false, onResult);
        }
        ...
        /// </code>
        /// </example>
        public static CacheRequestOperation RequestTexture(string url, CacheRequestConfiguration config, bool preLoad, Action<CachedTexture> onResult)
        {
            return CacheStorageImplement.RequestTexture(url, config, preLoad, onResult);
        }
        ...
        {
            return RequestTexture(url, new CacheRequestConfiguration(reRequestTime), false, onResult);
        }
        ...
        {
            return RequestTexture(url, new CacheRequestConfiguration(reRequestTime), preLoad, onResult);
        }
        ...
        {
            return RequestTexture(url, new CacheRequestConfiguration(requestType), false, onResult);
        }
        ...
        {
            return RequestTexture(url, new CacheRequestConfiguration(requestType), preLoad, onResult);
        }
        ...
        {
            return RequestTexture(url, new CacheRequestConfiguration(requestType, reRequestTime), preLoad, onResult);
        }
